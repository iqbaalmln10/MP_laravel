...
// Listener agar data refresh saat ID diatur oleh Alpine
on(['set-project' => function ($id) {
    $this->projectId = $id;
}]);
...
<div> <div class="flex flex-col h-full bg-white" x-init="$wire.projectId = selectedId">
